...
\usepackage[nospace,BoldFont,SlantFont,fallback,CJKnumber]{xeCJK}
...
\newcommand\fontnamezhei{WenQuanYi Zen Hei}
\newcommand\fontnamesong{AR PL UMing CN}
\newcommand\fontnamekai{AR PL UKai CN}
\newcommand\fontnamemono{WenQuanYi Zen Hei Mono}
\newcommand\fontnameroman{DejaVu Sans Mono}
\newcommand\fontromanbold{DejaVu Sans Mono Bold}

\setmainfont[BoldFont=\fontromanbold]{\fontnameroman}
\setsansfont[BoldFont=\fontromanbold]{\fontnameroman}
\setmonofont{\fontnameroman}
% 设置文档正文为宋体
\setCJKmainfont[BoldFont=\fontnamemono]{\fontnamehei}
%\setCJKsansfont[BoldFont=\fontnamehei]{\fontnamekai}
\setCJKsansfont[BoldFont=\fontnamezhei]{\fontnamehei}
...
\homepage{sd44.is-programming.com}                  % 可选项、如不需要可删除本行
